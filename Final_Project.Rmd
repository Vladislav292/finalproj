...
```{r}
edu <- read.csv("https://raw.githubusercontent.com/ChristineHsieh1231/mii/master/Educational%20Attainment.csv")
...
write.csv(edue,file="C:/Users/E15_W7/Desktop/edue.csv",row.names = FALSE)
```
